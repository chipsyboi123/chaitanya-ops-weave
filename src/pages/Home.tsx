...
import { ArrowRight, Shield, CheckCircle, Lock, FileText, Settings, Users } from "lucide-react";
      ...
      <section className="relative min-h-[85vh] flex items-center pt-20 lg:pt-24">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl">
            ...
            <p
              className="text-lg text-muted-foreground leading-relaxed mb-6 opacity-0 animate-fade-in"
              style={{ animationDelay: "0.3s" }}
            >
              We replace manual operations with automation across reporting, RM
              workflows, compliance knowledge, and client experience—so teams
              move faster and clients feel the difference.
            </p>
